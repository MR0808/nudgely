...
import { CompanyUserRegisterSchema } from '@/schemas/register';
...
const CompanyUserInitialRegistationForm = ({
    ...
    const form = useForm<z.infer<typeof CompanyUserRegisterSchema>>({
        resolver: zodResolver(CompanyUserRegisterSchema),
        defaultValues: {
            name: data.name,
