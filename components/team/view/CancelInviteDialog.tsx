...
import { CancelInviteDialogProps } from '@/types/team';
import { cancelTeamInvitation } from '@/actions/teamMember';
...
const CancelInviteDialog = ({
    ...
    const onCancel = () => {
        startTransition(async () => {
            const result = await cancelTeamInvitation(inviteId, teamId, slug);
            if (result.error) {
